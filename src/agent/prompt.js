...
export function buildSystemPrompt(config = catalogConfig) {
  ...
  return [
    ...
    '- Never show a raw id, GID (e.g. "gid://shopify/ProductVariant/...") or',
    '  internal URL in your reply. Tool results carry these so you can act on',
    '  them (matching a line, calling a tool again) — refer to items by name,',
    '  never by id, when talking to the buyer.',
    '',
